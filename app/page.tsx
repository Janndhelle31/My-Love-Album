...
const polaroids = [
  { id: 1, src: "https://images.unsplash.com/photo-1518133910546-b6c2fb7d79e3?w=400", top: "5%", left: "5%", rotate: -15, speed: 0.1 },
  { id: 2, src: "https://images.unsplash.com/photo-1523438885200-e635ba2c371e?w=400", top: "15%", left: "80%", rotate: 12, speed: 0.2 },
  { id: 3, src: "https://images.unsplash.com/photo-1516589174184-c685265142ec?w=400", top: "65%", left: "2%", rotate: 8, speed: 0.15 },
  { id: 4, src: "https://images.unsplash.com/photo-1494972308805-463bc619d34e?w=400", top: "85%", left: "75%", rotate: -10, speed: 0.25 },
  { id: 10, src: "https://images.unsplash.com/photo-1520854221257-1745133e1ef1?w=400", top: "40%", left: "85%", rotate: 20, speed: 0.18 },
];
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center py-12 md:py-24 px-4 overflow-x-hidden bg-[#FFFBF0] selection:bg-pink-200">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        {polaroids.map((p, idx) => {
          ...
          return (
            <motion.div
              key={p.id}
              style={{ top: p.top, left: p.left, rotate: p.rotate, y }}
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: idx > 2 ? 0.08 : 0.2, scale: 1 }}
              transition={{ duration: 1, delay: idx * 0.2 }}
              className={`absolute w-32 md:w-64 bg-white p-2 pb-8 md:pb-12 shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-white/50 rounded-sm ${idx > 2 ? 'hidden lg:block' : 'block'}`}
            >
      ...
      <div className="z-10 text-center max-w-7xl w-full">
        ...
        {/* 4. CATEGORY TILES (Modern Glassmorphism) */}
